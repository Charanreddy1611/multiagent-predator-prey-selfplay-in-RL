"""
Training script for MAPPO (Multi-Agent PPO) algorithm.
...
def train_mappo(
    ...
    n_good: int = 1,
    max_cycles: int = 200,
    self_play_strategy: str = "alternating",
    device: str = "cuda" if torch.cuda.is_available() else "cpu",
    save_dir: str = "checkpoints"
):
    """
    Train adversaries and good agents using MAPPO with self-play.
    Uses PettingZoo's Simple Tag environment.
    ...
    Args:
        ...
        self_play_strategy: Self-play strategy to use
        device: Device for training
        save_dir: Directory to save checkpoints
    """
    print("="*60)
    print("Training MAPPO with Self-Play")
    ...
    print(f"Self-Play Strategy: {self_play_strategy}")
    print("="*60 + "\n")
    ...
    # Note: Simple Tag has continuous obs space and discrete action space
    ...
    # Create MAPPO agents for adversaries (predators) and good agents (prey)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train MAPPO agents on Simple Tag")
